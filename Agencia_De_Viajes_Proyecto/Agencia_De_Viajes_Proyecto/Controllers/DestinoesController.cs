...
namespace Agencia_De_Viajes_Proyecto.Controllers
{
    public class DestinoesController : Controller
    {
        ...
        public DestinoesController(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("DestinoId,DestinoPaisName,DestinoCuidadName")] Destino destino)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DestinoId,DestinoPaisName,DestinoCuidadName")] Destino destino)
        {
